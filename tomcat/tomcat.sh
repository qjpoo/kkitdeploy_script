...
test -d $tomcat_install_path || mkdir -p $tomcat_install_path
test -f apache-tomcat-$tomcat_version.zip || wget http://mirrors.tuna.tsinghua.edu.cn/apache/tomcat/tomcat-$parent_version/v$tomcat_version/bin/apache-tomcat-$tomcat_version.zip
if [[ $? -eq 0 ]];then
unzip apache-tomcat-$tomcat_version.zip
cp -rf apache-tomcat-$tomcat_version/* $tomcat_install_path
chmod -R 755 $tomcat_install_path
