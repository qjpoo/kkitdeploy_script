...
scp base.config deploy_docker_node.sh ssh_trust_init.exp ssh_trust_add.exp root@$host:/root && ssh root@$host /root/deploy_docker_node.sh && ssh root@$host "rm -rf base.config deploy_docker_node.sh ssh_trust_init.exp ssh_trust_add.exp"
