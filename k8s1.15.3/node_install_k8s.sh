...
echo -e "\033[31m 这个是k8s一键部署脚本，node节点正在运行脚本中,请不要刷新或断开连接，结束会有相关提示！如果有任何问题请到公众号“devops的那些事”留言 \033[0m"
#sleep 5
#yum update
yum_update(){
	yum update -y
...
EOF
	yum -y install kubelet-1.15.3 kubeadm-1.15.3 kubectl-1.15.3 kubernetes-cni-0.7.5
